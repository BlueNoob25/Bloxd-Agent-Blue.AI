...
```mermaid
graph LR
A{Current} --> B(Memory Mesh v0.2.4)
A --> C(Admin Addition v0.2.5)
B -- More Themes --> D(Training Tutored v0.2.6)
C --> D
D --> E(Lore Accuracy v0.2.7)
E --> F[unplanned...]
```

### Memory Mesh (v0.2.4)
Introduces a panel that allows users to select one, multiple, or all chats, and once submitted, the AI, for *one response only*, will remember content from the selected chat(s) and will use the content to generate a response to the user's prompt. Currently in alpha, releases April 30th-May 3rd.
...
##
Contact us for any questions and suggestions! We would love feedback, especially from the community! Thank you for reading this!
